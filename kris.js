...
let listProduct21 = `🛒 Cara Pembelian: Kunjungi [website](${website}) atau bisa ketik : caratopup
 
🖥 Nama Server: ${server}
☎️ Tlpn/WA: ${owner}
🔰Telegram: ${telegram}
🔰Channel Telegram: ${channel}
🌐 Order Via Web : ${website}\n\n_${toko}_`;
reply(`${tek}\n\n${listProduct21}`) 
}
...
-----------------------------------
Silahkan pilih Menu yang kak *${cek("username", m.sender)}* inginkan, hanya tinggal copy dan paste pilihan topup yang telah disediakan
-----------------------------------
Silahkan Ketik	:

❍ hargapulsa ( Pulsa ) 
❍ topupgames ( Topup Game ) 
❍ hargapln ( Buy Token Pln ) 
...
❍ lita ( Lita ) 
❍ pubg ( Pubg Mobile ) 
❍ metalslug ( Metal slug Awakening ) 
